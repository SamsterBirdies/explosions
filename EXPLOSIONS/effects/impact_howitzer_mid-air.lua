dofile("mods/dlc1_weapons/effects/impact_howitzer_mid-air.lua")
dofile(path .. "/effects/util_dlc.lua")
dofile(path .. "/effects/util.lua")
SoundEvent = "mods/dlc1_weapons/effects/impact_howitzer_mid-air.lua"
fix_dupe("impact_howizter_mid-air", "mods/dlc1_weapons") --bruh devs mispelled howitzer
